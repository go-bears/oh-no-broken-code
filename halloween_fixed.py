...
while True:
    ...
    print "You will go dressed as a {} {} to the party.".format(adjective, noun)

    happy = raw_input("Are you happy with this choice? y/n: ")

    # Check if the user typed something like 'yes' or 'y' and
    # quit the program if they are happy.
    if happy == 'y':
        print "Glad you're happy. Go forth and party on!"
        exit()
        ...
        print "I didn't get that. Let's try again."   
        print happy